...
See [`examples/waypoint.toml`](https://github.com/redoapp/waypoint/blob/main/examples/waypoint.toml) in the repo for an annotated reference covering every option, including the commented-out alternatives for OAuth, WIF, MongoDB SRV discovery, Kubernetes impersonation, and Tailscale Services.
