...
[listeners.query_log]  # optional: per-statement audit logging
```
...
- [Query Logging](/waypoint/observability/query-logging/) — per-statement audit logging, levels, and ACL overrides.
